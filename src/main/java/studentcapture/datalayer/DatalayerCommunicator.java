...
//    @CrossOrigin
//    @RequestMapping(
//            value = "/setUserConfig/{userID}",
//            method = RequestMethod.POST
//    )
//    public boolean setUserConfig(@PathVariable(value = "userID") int userID,
//                                 @RequestBody Settings c) {
//        System.err.println("\n\n\n\nSettings: " + c + "\n\n\n\n");
//        boolean hej = userDAO.setEmail(userID, c.getEmail());
//        return hej && settingsDAO.setUserConfig(userID, c);
//    }
