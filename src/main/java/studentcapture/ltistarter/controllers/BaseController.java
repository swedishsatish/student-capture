 ...
 */
package studentcapture.ltistarter.controllers;
...
public class BaseController {
     ...
     */
    public void commonModelPopulate(HttpServletRequest req, Principal principal, Model model) {
        System.out.println("BaseController\n");
        System.out.println("getLocalName: " + req.getLocalName() + "\n");
        System.out.println("getParameter: " + req.getParameter("lti_version") + "\n");
