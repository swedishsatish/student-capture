 ...
 */
package studentcapture.ltistarter.repository;

import studentcapture.ltistarter.model.LtiContextEntity;
...
public interface LtiContextRepository extends PagingAndSortingRepository<LtiContextEntity, Long> {
     ...
     */
    public LtiContextEntity findByContextKey(String key);

    /**
     * @param key the unique key
     * @return the number of keys removed (0 or 1)
     */
    public int deleteByContextKey(String key);
}
